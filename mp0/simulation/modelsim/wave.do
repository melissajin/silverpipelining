...
add wave -noupdate -color {Sky Blue} -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/i_mem_resp
add wave -noupdate -color {Sky Blue} -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/i_mem_read
add wave -noupdate -color {Sky Blue} -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/i_mem_rdata
add wave -noupdate -color {Sky Blue} -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/i_mem_address
add wave -noupdate -color {Sky Blue} -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/d_mem_resp
add wave -noupdate -color {Sky Blue} -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/d_mem_read
add wave -noupdate -color {Sky Blue} -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/d_mem_write
add wave -noupdate -color {Sky Blue} -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/d_mem_rdata
add wave -noupdate -color {Sky Blue} -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/d_mem_address
add wave -noupdate -color {Sky Blue} -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/d_mem_wdata
...
add wave -noupdate -group dest-nzp -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/hazard_detection_inst/nzp_ID
add wave -noupdate -group dest-nzp -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/hazard_detection_inst/nzp_EX
add wave -noupdate -group dest-nzp -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/hazard_detection_inst/nzp_MEM
add wave -noupdate -group dest-nzp -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/hazard_detection_inst/nzp_WB
...
add wave -noupdate -group alu -color Magenta -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/alu_inst/aluop
add wave -noupdate -group alu -color Magenta -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/alu_inst/a
add wave -noupdate -group alu -color Magenta -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/alu_inst/b
add wave -noupdate -group alu -color Magenta -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/alu_inst/f
...
add wave -noupdate -expand -group forward_src2 -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/forward_sr2_mux/sel
add wave -noupdate -expand -group forward_src2 -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/forward_sr2_mux/a
add wave -noupdate -expand -group forward_src2 -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/forward_sr2_mux/b
add wave -noupdate -expand -group forward_src2 -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/forward_sr2_mux/c
add wave -noupdate -expand -group forward_src2 -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/forward_sr2_mux/d
add wave -noupdate -expand -group forward_src2 -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/forward_sr2_mux/f
add wave -noupdate -expand -group mdr_mux_ex -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/mdrmux_ex/sel
add wave -noupdate -expand -group mdr_mux_ex -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/mdrmux_ex/a
add wave -noupdate -expand -group mdr_mux_ex -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/mdrmux_ex/b
add wave -noupdate -expand -group mdr_mux_ex -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/mdrmux_ex/c
add wave -noupdate -expand -group mdr_mux_ex -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/mdrmux_ex/d
add wave -noupdate -expand -group mdr_mux_ex -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/mdrmux_ex/f
add wave -noupdate -radix hexadecimal /mp0_tb/dut/cpu_inst/datapath/mdr_MEM_out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {36526030 ps} 0}
...
update
WaveRestoreZoom {36515789 ps} {36537011 ps}
